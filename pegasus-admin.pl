...
system('cls');
system('title Pegasus Admin ');
system "color 0a";
print"\n";
print "\t\n";
print "\t            Pegasus Admin                      \n";
print "\t         Created By Pegasus                    \n";
print "\t       Muhammad Sobri Maulana                  \n";
print "\t      Synchronize Hacker Team                  \n";
print "\t\n";
print "\n";
...
@path2=('redaktur/','webadmin/','phpmyadmin/',':2082/','wp-login.php','wp-login.php/login.html','adminsekolah/','administrator/','webmaster/',
'moderator/','admin@web/','operator/','adminlogin/','login@web/','achterkant/index.php/' ,'admin/login.htm/','robots.txt','robots.txt.dist','admin.%EXT%',
'login.htm','login.html','login/','login.%EXT%','adm/','admin/','admin/account.html','admin/login.html','admin/login.htm','admin/home.%EXT%','admin/controlpanel.html',
'admin/controlpanel.htm','admin/cp.%EXT%','admin/adminLogin.html','admin/adminLogin.htm','admin/admin_login.%EXT%','admin/controlpanel.%EXT%','admin/admin-login.%EXT%',
'admin-login.%EXT%','admin/account.%EXT%','admin/admin.%EXT%','admin.htm','admin.html','adminitem/','adminitem.%EXT%','adminitems/','adminitems.%EXT%','administrator/',
'administrator/login.%EXT%','administrator.%EXT%','administration/','administration.%EXT%','adminFinder','adminLogin/','adminlogin.%EXT%','admin_area/admin.%EXT%',
'admin_area/','admin_area/login.%EXT%','manager/','manager.%EXT%','letmein/','letmein.%EXT%','superuser/','superuser.%EXT%','access/','access.%EXT%','sysadm/',
'sysadm.%EXT%','superman/','supervisor/','panel.%EXT%','control/',
...
'adminarea/admin.cfm','adminarea/login.cfm','panel-administracion/index.cfm','panel-administracion/admin.cfm','modelsearch/index.cfm',
'modelsearch/admin.cfm','admincontrol/login.cfm','adm/admloginuser.cfm','admloginuser.cfm','admin2.cfm','admin2/login.cfm','admin2/index.cfm','usuarios/login.cfm',
'adm/index.cfm','adm.cfm','affiliate.cfm','adm_auth.cfm','memberadmin.cfm','administratorlogin.cfm','login/admin.php'
);
...
@path2=('redaktur/','adm/','_adm_/','_admin_/','administrator_/','operator/','sika/','develop
);
